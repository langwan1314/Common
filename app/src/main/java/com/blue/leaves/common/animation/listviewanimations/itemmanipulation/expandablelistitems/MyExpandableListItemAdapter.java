...
package com.blue.leaves.common.animation.listviewanimations.itemmanipulation.expandablelistitems;
...
import com.blue.leaves.animation.listview.manipulation.expandablelistitem.ExpandableListItemAdapter;
import com.blue.leaves.common.R;
import com.blue.leaves.common.animation.listviewanimations.util.BitmapCache;
...
public class MyExpandableListItemAdapter extends ExpandableListItemAdapter<Integer> {
    ...
    public MyExpandableListItemAdapter(final Context context) {
        super(context, R.layout.activity_animations_listview_expandablelistitem_card, R.id.activity_expandablelistitem_card_title, R.id.activity_expandablelistitem_card_content);
        mContext = context;
