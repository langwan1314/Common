...
package com.blue.leaves.common.animation.listviewanimations.googlecards;
...
public class GoogleCardsAdapter extends ArrayAdapter<Integer> {
    ...
    public View getView(final int position, final View convertView, final ViewGroup parent) {
        ...
        if (view == null) {
            view = LayoutInflater.from(mContext).inflate(R.layout.activity_animations_listview_googlecards_card, parent, false);
