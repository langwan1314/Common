package com.blue.leaves.common.textview.tagview;
...
import com.blue.leaves.textview.tagview.Tag.Constants;
import com.blue.leaves.textview.tagview.Tag.OnTagClickListener;
import com.blue.leaves.textview.tagview.Tag.OnTagDeleteListener;
import com.blue.leaves.textview.tagview.Tag.Tag;
import com.blue.leaves.textview.tagview.Tag.TagClass;
import com.blue.leaves.textview.tagview.Tag.TagView;
...
public class TagViewMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tagview_main);
...
//                final MaterialDialog dialog = new MaterialDialog(TagViewMainActivity.this);
//                dialog.setMessage("\"" + tag.text + "\" will be delete. Are you sure?");
//                dialog.setPositiveButton("Yes", new View.OnClickListener() {
//                    @Override
//                    public void onClick(View v) {
//                        view.remove(position);
//                        Toast.makeText(TagViewMainActivity.this, "\"" + tag.text + "\" deleted", Toast.LENGTH_SHORT).show();
//                        dialog.dismiss();
//                    }
//                });
