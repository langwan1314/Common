package com.blue.leaves.common.task;
...
import com.blue.leaves.util.task.SugarTask;

public class SugarTaskFragment extends Fragment {
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_sugar_task, container, false);
    }
