package com.blue.leaves.common.animation.flip.demo.adapter;
...
import com.blue.leaves.animation.flip.utils.IO;
import com.blue.leaves.animation.flip.utils.UI;
import com.blue.leaves.common.R;
import com.blue.leaves.common.animation.flip.demo.data.Travels;
...
public class TravelAdapter extends BaseAdapter {
  ...
  public View getView(int position, View convertView, ViewGroup parent) {
    ...
    if (convertView == null) {
      layout = inflater.inflate(R.layout.animal_flip_complex1, null);
