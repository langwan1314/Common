...
import com.blue.leaves.common.animation.listviewanimations.appearance.AppearanceExamplesActivity;
import com.blue.leaves.common.animation.listviewanimations.googlecards.GoogleCardsActivity;
import com.blue.leaves.common.animation.listviewanimations.gridview.GridViewActivity;
import com.blue.leaves.common.animation.listviewanimations.itemmanipulation.ItemManipulationsExamplesActivity;
...
public class ListviewMainActivity extends Activity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_animations_listview_main);
    ...
    private class RetrievePurchasesRunnable implements Runnable {
        ...
        public void run() {
            try {
                ...
                Toast.makeText(ListviewMainActivity.this, getString(R.string.exception), Toast.LENGTH_LONG).show();
            }
        }
    }
