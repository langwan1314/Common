...
package com.blue.leaves.common.textview.jumpingbeans;
...
import com.blue.leaves.textview.jumpingbeans.JumpingBeans;
...
public class JumpingBeanMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jumpingbean_main);
    }
