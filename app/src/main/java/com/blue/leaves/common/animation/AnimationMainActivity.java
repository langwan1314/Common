...
public class AnimationMainActivity extends BaseMainActivity {
    ...
    String[] data1 = {"flip", "listviewanimations", "splash", "base1", "base2"};
    String[
            ] data2 =
    ...
    private Class[] mListClass = {FlipMainActivity.class, ListviewMainActivity.class, SplashMainActivity.class, Base1AnimationActivity
