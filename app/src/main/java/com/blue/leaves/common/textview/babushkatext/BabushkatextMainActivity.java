 ...
 */
package com.blue.leaves.common.textview.babushkatext;
...
import com.blue.leaves.textview.babushkatext.BabushkaText;
...
public class BabushkatextMainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_babushkatextmain);
