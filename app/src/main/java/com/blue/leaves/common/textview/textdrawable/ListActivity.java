...
import com.blue.leaves.common.textview.textdrawable.sample.DrawableProvider;
import com.blue.leaves.textview.textdrawable.TextDrawable;
import com.blue.leaves.textview.textdrawable.util.ColorGenerator;
...
public class ListActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_textdrawable_list);
    ...
    private class SampleAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = View.inflate(ListActivity.this, R.layout.text_drawable_list_item_layout, null);
