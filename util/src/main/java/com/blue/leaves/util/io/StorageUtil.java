...
import com.blue.leaves.util.StringUtil;
...
public class StorageUtil {
    ...
    // 有sd卡时应用程序的存储根目录
    public static final String APP_SDCARD_AMOUNT_ROOT_PATH = "/tencent/fifteen";
    // 无sd卡时应用程序的存储根目录
    public static final String APP_SDCARD_UNAMOUNT_ROOT_PATH = "/fifteen";
    // 有sd卡时应用程序缓存文件的存储跟目录
    ...
    public static String getCommonRootDir() {
        ...
        if (isSDCardExistAndCanWrite()) {
            ...
            dirPath = Utils.getAppContext()
                    .getFilesDir().getAbsolutePath()
                    + APP_SDCARD_UNAMOUNT_ROOT_PATH;
        }
        Log.d(TAG, "getCommonRootDir dirPath:" + dirPath);
    ...
    public static String getCommonPath(String path) {
        ...
        Log.d(TAG, "getCommonPath fullPath:" + fullPath);
    ...
    public static String getPicDir() {
        return getPath(getCommonRootDir() + PIC_DIR_PATH,
                true);
    }
    ...
    public static String getInternalCachePath() {
        String dirPath = Utils.getAppContext()
    ...
    public static void clearCache(final Context context) {
        IOUtil.recursiveDelete(context
                .getExternalCacheDir());
        IOUtil.recursiveDelete(context.getCacheDir());
    }
    ...
    public static boolean isClearCard() {
        String sdcard = StorageUtil.getCacheDir();
        StatFs statFs = null;
        if (sdcard != null) {
            try {
    ...
    public static boolean isSDCardFull() {
        ...
        if (!StringUtil.isNullOrEmpty(sdcard)) {
            ...
            long blocks = statFs.getAvailableBlocks();
            long availableSpare = blocks * blockSize;
            Log.v(TAG, "isSDCardFull availableSpare:"
                    + availableSpare);
