...
public class AdapterViewUtil {
     ...
     * Unlike {@link AdapterView#getPositionForView(android.view.View)}, returned position will reflect the position of the item given
     * view is representing,
     ...
     * @param view            an adapter item or a descendant of an adapter item. This must be visible in given AdapterView at the time
     *                        of the call.
     * @return the position of the item in the AdapterView represented by given view, or {@link AdapterView#INVALID_POSITION} if the view
     * does not
     ...
     * @param view        an adapter item or a descendant of an adapter item. This must be visible in given AdapterView at the time of
     *                    the call.
     * @return the position of the item in the AdapterView represented by given view, or {@link AdapterView#INVALID_POSITION} if the view
     * does not
     * correspond to a list item (or it is not visible).
