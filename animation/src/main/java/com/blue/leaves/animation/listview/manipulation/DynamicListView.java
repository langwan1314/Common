...
import com.blue.leaves.animation.listview.manipulation.animateaddition.AnimateAdditionAdapter;
import com.blue.leaves.animation.listview.manipulation.dragdrop.DragAndDropHandler;
import com.blue.leaves.animation.listview.manipulation.dragdrop.DraggableManager;
import com.blue.leaves.animation.listview.manipulation.dragdrop.DynamicListViewWrapper;
import com.blue.leaves.animation.listview.manipulation.dragdrop.OnItemMovedListener;
import com.blue.leaves.animation.listview.manipulation.swipedismiss.DismissableManager;
import com.blue.leaves.animation.listview.manipulation.swipedismiss.OnDismissCallback;
import com.blue.leaves.animation.listview.manipulation.swipedismiss.SwipeDismissTouchListener;
import com.blue.leaves.animation.listview.manipulation.swipedismiss.SwipeTouchListener;
import com.blue.leaves.animation.listview.manipulation.swipedismiss.undo.SwipeUndoAdapter;
import com.blue.leaves.animation.listview.manipulation.swipedismiss.undo.SwipeUndoTouchListener;
import com.blue.leaves.animation.listview.manipulation.swipedismiss.undo.UndoCallback;
...
public class DynamicListView extends ListView {
    ...
    /**
     * The {@link com.blue.leaves.animation.listview.manipulation.dragdrop.DragAndDropHandler}
    ...
    /**
     * The {@link com.blue.leaves.animation.listview.manipulation.swipedismiss.SwipeTouchListener}
    ...
    /**
     * The {@link com.blue.leaves.animation.listview.manipulation.TouchEventHandler}
    ...
    /**
     * The {@link com.blue.leaves.animation.listview.manipulation.animateaddition.AnimateAdditionAdapter}
     ...
     *
     * @param onDismissCallback the {@link com.blue.leaves.animation.listview.manipulation.swipedismiss.OnDismissCallback}
     ...
     *
     * @param undoCallback the {@link com.blue.leaves.animation.listview.manipulation.swipedismiss.undo.UndoCallback}
     *                     that is used.
     */
    ...
    /**
     * Enables swipe to dismiss with contextual undo for this {@code DynamicListView}.
     * This method requires that a {@link com.blue.leaves.animation.listview.manipulation.swipedismiss.undo.SwipeUndoAdapter} has been set.
     * It is allowed to have the {@code SwipeUndoAdapter} wrapped in a {@link com.blue.leaves.animation.listview.core.BaseAdapterDecorator}.
     *
    ...
    /**
     * Disables any swipe to dismiss functionality set by either {@link #enableSwipeToDismiss(com.blue.leaves.animation.listview.manipulation.swipedismiss.OnDismissCallback)},
     * {@link #enableSwipeUndo(com.blue.leaves.animation.listview.manipulation.swipedismiss.undo.UndoCallback)} or {@link #enableSimpleSwipeUndo()}.
     */
     ...
     * and should implement {@link com.blue.leaves.animation.listview.core.Swappable}.
     *
     ...
     *                                            and the adapter does not implement {@link com.blue.leaves.animation.listview.core.Swappable}.
     */
    @Override
    ...
    /**
     * Sends a cancel event to given {@link com.blue.leaves.animation.listview.manipulation.TouchEventHandler}.
     *
     ...
     *
     * @throws java.lang.IllegalStateException if the adapter that was set does not implement {@link com.blue.leaves.animation.listview.core.util.Insertable}.
     */
    ...
    /**
     * Sets the {@link com.blue.leaves.animation.listview.manipulation.dragdrop.DraggableManager} to be used
    ...
    /**
     * Sets the {@link com.blue.leaves.animation.listview.manipulation.dragdrop.OnItemMovedListener}
    ...
    /**
     * Sets the {@link com.blue.leaves.animation.listview.manipulation.swipedismiss.DismissableManager} to specify which views can or cannot be swiped.
     * <p/>
     ...
     * @param position the position of the item in the {@link android.widget.ListAdapter}. Must be visible.
     *
     * @throws java.lang.IllegalStateException if the {@link com.blue.leaves.animation.listview.manipulation.swipedismiss.SwipeTouchListener}
     *                                         that is enabled does not extend {@link com.blue.leaves.animation.listview.manipulation.swipedismiss.SwipeDismissTouchListener}.
     */
     ...
     *
     * @throws java.lang.IllegalStateException if the {@link com.blue.leaves.animation.listview.manipulation.swipedismiss.SwipeTouchListener}
     *                                         that is enabled doe snot extend {@link com.blue.leaves.animation.listview.manipulation.swipedismiss.undo.SwipeUndoTouchListener}.
     */
