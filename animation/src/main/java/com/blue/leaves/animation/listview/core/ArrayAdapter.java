 ...
 * 一个ArrayList的adapter，同时实现了Swappable用于交换以及Insertable用于插入
 */
...
public abstract class ArrayAdapter<T> extends BaseAdapter implements Swappable, Insertable<T> {
    ...
    /**
     * Adds the objects in the specified collection to the end of this List. The objects are added in the order in which they are
