...
package com.blue.leaves.animation.listview.manipulation.swipedismiss;
...
import com.blue.leaves.animation.listview.core.util.AdapterViewUtil;
import com.blue.leaves.animation.listview.core.util.ListViewWrapper;
import com.blue.leaves.animation.listview.manipulation.TouchEventHandler;
...
public abstract class SwipeTouchListener implements View.OnTouchListener, TouchEventHandler {
    ...
    /**
     * The {@link com.blue.leaves.animation.listview.manipulation.swipedismiss.DismissableManager} which decides
    ...
    /**
     * An {@link com.blue.leaves.nineoldandroids.animation.AnimatorListener} that notifies when the fling animation has ended.
     */
    ...
    /**
     * An {@link com.blue.leaves.nineoldandroids.animation.AnimatorListener} that performs the dismissal animation when the current animation has ended.
     */
